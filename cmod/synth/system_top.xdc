...
# set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { I2C_SCL }]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
# set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { I2C_SDA }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]

# set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { DBG_GPIO[0] }]; #IO_L12P_T1_MRCC_16 Sch=pio[03]
# set_property -dict { PACKAGE_PIN K3    IOSTANDARD LVCMOS33 } [get_ports { DBG_GPIO[1] }]; #IO_L7N_T1_AD6N_35 Sch=pio[04]
# set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { DBG_GPIO[2] }]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
# set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { DBG_GPIO[3] }]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
...
# set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 PULLTYPE PULLDOWN} [get_ports { BTNS[2] }]; #IO_L2P_T0_34 Sch=pio[26]
# set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports { LEDS[2] }]; #IO_L2N_T0_34 Sch=pio[27]
# set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports { LEDS[3] }]; #IO_L1P_T0_34 Sch=pio[28]
