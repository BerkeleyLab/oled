...
lv_font_conv --size 28 --bpp 4 --format lvgl --no-kerning --no-compress --lv-include lv_font.h -o ../firmware/lv_font_fa.c \
--font fa-solid-900.woff -r 0xf2c7,0xf0e7,0xf1e6,0xf2db,0xf519,0xf09c
...
# big icons
SYM_B="thermometer-full bolt plug microchip broadcast-tower unlock"
